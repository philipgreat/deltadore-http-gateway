...
final public class RXTXPort extends SerialPort
{
	...
	*/
	...
	{
		if (debug){
			//reportln( "RXTXPort:RXTXPort("+name+") called");
			
			z.reportln( "RXTXPort:RXTXPort("+name+") called");
			//System.out.println("RXTXPort:RXTXPort("+name+") called");
		}
	/* 
	...
	*/
		...
		private  String toHexString(byte[] fieldData) {
	...
	*/
		public void write( byte b[] ) throws IOException
		{
			if (debug_write)
			{
				z.reportln( "Entering RXTXPort:SerialOutputStream:write(" + b.length + "): "+toHexString(b)+" "/* + new String(b)*/ );
			}
			if( speed == 0 ) return;
			if ( monThreadisInterrupted == true )
			{
