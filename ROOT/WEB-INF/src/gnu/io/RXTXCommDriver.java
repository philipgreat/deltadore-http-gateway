...
*/
    ...
    */
	private boolean registerSpecifiedPorts(int PortType)
	{
		...
		if (debug)
			System.out.println("try to read: "+System.getProperty("gnu.io.rxtx.SerialPorts"));
		...
		try {
			switch (PortType) {
				case CommPortIdentifier.PORT_SERIAL:
					...
					{
						if (debug) System.out.println("return new RXTXPort( deviceDirectory + PortName )"+ deviceDirectory + PortName);
